...
class SingleUserProfilePage extends StatefulWidget {
  ...
  @override
  State<SingleUserProfilePage> createState() => _ProfilePageSingleUserProfilePage();
}

class _ProfilePageSingleUserProfilePage extends State<SingleUserProfilePage> {
                      ...
                      builder: (context, postState) {
                        if (postState is PostLoaded) {
                          final posts = postState.posts
                              .where((post) => post.creatorId == singleUser.uid)
                              .toList();
