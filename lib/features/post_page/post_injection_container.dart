...
import 'package:instagram_clone/features/post_page/data/remote_data_sources/post_remote_data_source_impl.dart';
import 'package:instagram_clone/features/post_page/data/repositories/post_repository_impl.dart';
...
//Remote Data Source Registration
  sl.registerLazySingleton<PostRemoteDataSource>(() => PostRemoteDataSourceImpl(
      fireStore: sl.call(), firebaseStorage: sl.call()));
}
